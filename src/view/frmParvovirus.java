...
public class frmParvovirus extends javax.swing.JFrame {

    private int x, y;
    
    public frmParvovirus() {
        initComponents();
    ...
    private void initComponents() {
        ...
        lblImage.setIcon(new javax.swing.ImageIcon(getClass().getResource("/image/parvo.jpg"))); // NOI18N
        Pane.add(lblImage);
        ...
        jLabel1.setText("PARVOVIRUS");
        jPanel1.add(jLabel1);
        jLabel1.setBounds(165, 10, 298, 46);
        ...
        jLabel6.setText("Es una enfermedad que afecta principalmente a los intestinos,");
        Pane.add(jLabel6);
        jLabel6.setBounds(586, 148, 340, 29);

        jLabel7.setFont(new java.awt.Font("Tahoma", 0, 12)); // NOI18N
        jLabel7.setText("Se le tiene que rehidratar seguidamente, y medicarle con la pastilla");
        Pane.add(jLabel7);
